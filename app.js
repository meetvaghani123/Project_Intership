...
const OPEN_WEATHER_KEY = '65a625e401e486d366734375c451a301'
...
mongoose.connect("mongodb+srv://admin-meet:admin@cluster0.6d4vq8m.mongodb.net/weatherDB", {useNewUrlParser: true});
...
const cronJob = new CronJob('42 7 * * *', run);
cronJob.start();
                    ...
                    forecastInfo1.then(function(result){
                        ...
                        forecastInfo2.then(function(result){
                            ...
                            let transporter = nodeMailer.createTransport({
                              ...
                              let mailOptions = {
                                from: '"Weather Alert" <weatheralert01@gmail.com>', // sender address
                                ...
                                <p>Maximum Temperature: ${weatherData1.temp_max}°C</p>
                                <p>Minimum Temperature: ${weatherData1.temp_min}°C</p>
                                ...
                                <p>Maximum Temperature: ${weatherData2.temp_max}°C</p>
                                <p>Minimum Temperature: ${weatherData2.temp_min}°C</p>
...
app.post("/update",function(req,res){
    ...
    Weather.updateMany({email:emailId},{name:userName,location:userLocation,days:day},function(err){
        if(err){
            console.log(err);
